...
"font-size: 18px; /* Taille de la police */\n"
"font-weight: bold; /* Texte en gras */"));
        ajout = new QPushButton(maincontent_3);
        ajout->setObjectName("ajout");
        ajout->setGeometry(QRect(50, 130, 201, 41));
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ajout->setText(QCoreApplication::translate("MainWindow", "ajouter mat\303\251riel", nullptr));
