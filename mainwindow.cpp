...
//partie mtaa slim -----------------------------------------------------------------------------------------------------------
    ...
    //doudiii
    ui->tableView_5->setModel(ptmp.afficher());
    button_doudi();
...
void MainWindow::afficherStatistiquesPartenaires()
        ...
        {
            for (int row = 0; row < ui->tableView_5->model()->rowCount(); ++row) {
                QPushButton *update_button = new QPushButton("Update", this);
                update_button->setStyleSheet("QPushButton {"
                                             "background-color:#437FF7;border-radius :5px; "
                                             "color : #fff;"
                ...
                connect(update_button, &QPushButton::clicked, [this, row]() {
                    ...
                    p.set_id(ui->tableView_5->model()->index(row, 0).data().toInt());
                    p.set_nom(ui->tableView_5->model()->index(row, 1).data().toString());
                    p.set_description(ui->tableView_5->model()->index(row, 2).data().toString());
                    p.set_chefDeProjet(ui->tableView_5->model()->index(row, 3).data().toString());

                    QString dateString = ui->tableView_5->model()->index(row, 4).data().toString();
                    QStringList parts = dateString.split("T"); // Split at "T" to separate date and time parts
                    QString datePart = parts[0]; // Extract the date part
                    QDate date = QDate::fromString(datePart, "yyyy-MM-dd");
                    if (date.isValid()) {
                    ...
                    QString dateString1 = ui->tableView_5->model()->index(row, 5).data().toString();
                    QStringList parts1 = dateString1.split("T"); // Split at "T" to separate date and time parts
                    QString datePart1 = parts1[0]; // Extract the date part
                    QDate date1 = QDate::fromString(datePart1, "yyyy-MM-dd");
                    if (date1.isValid()) {
                    ...
                    p.set_budget(ui->tableView_5->model()->index(row, 6).data().toFloat());
                    p.set_statut(ui->tableView_5->model()->index(row, 7).data().toString());
                    p.set_adresse(ui->tableView_5->model()->index(row, 8).data().toString());
                    p.set_upload(ui->tableView_5->model()->index(row, 9).data().toString());
                ...
                connect(delete_button, &QPushButton::clicked, [this, row]() {
                    on_delete_projet_clicked(ui->tableView_5->model()->index(row, 0).data().toInt());
                });

                ui->tableView_5->setIndexWidget(ui->tableView_5->model()->index(row, 10), update_button);
                ui->tableView_5->setIndexWidget(ui->tableView_5->model()->index(row, 11), delete_button);
            }
        }

        void MainWindow::on_ajmateriel_7_clicked()
        {
        ...
        void MainWindow::on_modifier_projet_clicked(Projet p)
        {
            ...
            ui->lineEdit_nom_4->setText(p.get_nom());
            ui->lineEdit_description_4->setText(p.get_description());
            ui->lineEdit_chef_4->setText(p.get_chefDeProjet());
            ui->dateEdit_inscription_6->setDate(p.get_dateDebut());
            ui->dateEdit_inscription_7->setDate(p.get_dateFinPrevu());
            ui->lineEdit_budget_4->setValue(p.get_budget());
            ui->lineEdit_status_4->setText(p.get_statut());
            ui->lineEdit_adresse_6->setText(p.get_adresse());
        ...
        {
            int id = ui->tableView_5->model()->index(ui->tableView_5->currentIndex().row(), 0).data().toInt();
            QString nom = ui->lineEdit_nom_4->text().trimmed();
            QString description = ui->lineEdit_description_4->text().trimmed();
            QString chefDeProject = ui->lineEdit_chef_4->text().trimmed();
            QDate dateDebut = ui->dateEdit_inscription_6->date();
            QDate dateFinPrevu = ui->dateEdit_inscription_7->date();
            float budget = ui->lineEdit_budget_4->value();
            QString statut = ui->lineEdit_status_4->text().trimmed();
            ...
            QString upload = ui->imageLabel_3->text();  // Ou autre champ contenant l'image uploadée
        ...
        void MainWindow::on_uploadButton_3_clicked()
        {
            ...
            ui->imageLabel_3->setPixmap(image.scaled(ui->imageLabel_3->size(), Qt::KeepAspectRatio, Qt::SmoothTransformation));
        ...
        void MainWindow::on_tri_3_currentTextChanged(const QString &arg1)
        {

            if (arg1=="ID"){
                ui->tableView_5->setModel(ptmp.sort("id"));
                button_doudi();
            }else if (arg1=="NOM"){
                ui->tableView_5->setModel(ptmp.sort("nom"));
                button_doudi();
            }else if (arg1=="lieu"){
                ui->tableView_5->setModel(ptmp.sort("lieu"));
                button_doudi();
            }else if (arg1=="age"){
                ui->tableView_5->setModel(ptmp.sort("age"));
                button_doudi();
            }else if (arg1=="date"){
                ui->tableView_5->setModel(ptmp.sort("date_event"));
                button_doudi();
            }else if (arg1=="dure"){
                ui->tableView_5->setModel(ptmp.sort("dure"));
                button_doudi();
            }else if (arg1=="type"){
                ui->tableView_5->setModel(ptmp.sort("type"));
                button_doudi();
            }else if (arg1=="prix"){
                ui->tableView_5->setModel(ptmp.sort("prix_inscrit"));
                button_doudi();
            }else if (arg1=="adresse"){
                ui->tableView_5->setModel(ptmp.sort("adresse"));
                button_doudi();
            }
        ...
        void MainWindow::on_recherche_label_3_textChanged(const QString &arg1)
        {
        ...
        void MainWindow::on_pushButton_25_clicked()
        {
            ...
            if (model) {
                ...
                ui->label_stat_4->setPixmap(pixmap);
        ...
        void MainWindow::on_map_3_clicked()
        {
            ...
            if (model) {
                ...
                foreach(const QModelIndex &selectedIndex, selectedIndexes) {
                    ...
                    if (!selectedRows.contains(row)) {
                        ...
                        if (parties.size() >= 2) {
                            ui->quickWidget_Map_View_3->setSource(QUrl(QStringLiteral("qrc:/img/QmlMap.qml")));
                            ui->quickWidget_Map_View_3->show();

                            auto obje = ui->quickWidget_Map_View_3->rootObject();
                            if (obje) {
        ...
        void MainWindow::on_btnProjects_2_clicked()
        {
        ...
        void MainWindow::on_ajouterClient_3_clicked()
        {
            ...
            QString description = ui->description_3->text().trimmed();
            QString chefDeProject = ui->chefDeProject_3->text().trimmed();
            QDate dateDebut = ui->dateDebut_3->date();
            QDate dateFinPrevu = ui->dateFinPrevu_3->date();
            float budget = ui->budget_4->value();
            QString statut = ui->statut_5->text().trimmed();
            ...
            if (A.ajouter()) {
                ...
                ui->chefDeProject_3->clear();
                ui->statut_5->clear();
                ui->budget_4->setValue(0);
                ui->lineEdit_adresse_5->clear();
                ui->dateDebut_3->setDate(QDate::currentDate());
                ui->dateFinPrevu_3->setDate(QDate::currentDate());
...
//////////remaaaaaaaaaaaaaaaaa

        void MainWindow::button_maram()
        {
            QSortFilterProxyModel *proxy = qobject_cast<QSortFilterProxyModel*>(ui->tableView_2->model());
            if (!proxy) return;
            ...
            for (int row = 0; row < proxy->rowCount(); ++row) {
                ...
                ui->tableView_2->setIndexWidget(proxy->index(row, 6), update_button);
                ui->tableView_2->setIndexWidget(proxy->index(row, 7), delete_button);
            }
        }
        ...
        void MainWindow::on_ajouterClient_clicked()
        {
            ...
            QString typeStr = ui->comboBox_type_2->currentText();
            ...
            if (client.ajouter()) {
                ...
                proxyModel1->setSourceModel(this->client.afficher());
                button_maram();
                setupHistoriqueTable(); // Rafraîchir l'historique
        ...
        void MainWindow::on_exportPdfButton_clicked()
        {
            ...
            html += "<p>Nombre total de clients: " + QString::number(ui->tableView_2->model()->rowCount()) + "</p>";
        ...
        {
            auto *layout = new QVBoxLayout();  // on ne passe pas parent ici
            parentWidget->setLayout(layout);   // on applique explicitement
        ...
        /*void MainWindow::on_showStatsButton_clicked()  // Connecte ce slot à ton bouton
{
    ...
    ui->stackedWidget->setCurrentIndex(ui->stackedWidget->count() - 1);  // Dernière page
        ...
        {
            updateClientStats();
            ui->stackedWidget_6->setCurrentIndex(ui->stackedWidget_6->count() - 1);  // Dernière page
        }
        ...
        void MainWindow::on_lineEdit_recherche_textChanged(const QString &text)
        {
            ...
            connect(&timer, &QTimer::timeout, this, [this, text]() {
                if (text == ui->lineEdit_recherche->text()) {
                    proxyModel1->setSourceModel(client.rechercher(text.trimmed()));
                    button_maram();
                }
            });
        ...
        void MainWindow::on_btnclients_2_clicked()
        {
            ui->stackedWidget->setCurrentIndex(3);
